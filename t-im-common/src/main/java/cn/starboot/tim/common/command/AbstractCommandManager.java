...
public abstract class AbstractCommandManager<V extends AbstractCmdHandler<C, F, P>, C extends ImChannelContext<F>, F extends ImConfig<P>, P extends TIMProcessor> {
